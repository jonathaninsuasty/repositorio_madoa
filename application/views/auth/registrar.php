...
<body>
	...
	<div class="container">
        <div class="row">
            <div class="col-md-5 banner"></div>
            <div class="col-md-7 login-form-2">
                <h3>REGISTRARSE EN EL REPOSITORIO</h3><br>
                <form>
                    <div class="form-group">
                        <input type="TEXT" class="form-control" placeholder="Tus nombres *" id="email" required="" />
                    </div>
                    <div class="form-group">
                        <input type="TEXT" class="form-control" placeholder="Tus apellidos *" id="email" required="" />
                    </div>
                    <div class="form-group">
                    ...
                    <br>
                    <div class="form-group">
                        <input type="submit" class="btnSubmit" value="REGISTRARSE" id="boton" />
                    </div>
                    <div class="form-group">
                        <a href="#" class="ForgetPwd" value="Iniciar sesión">Olvidó su contraseña?</a><br>
                        <a href="/auth/registrar" class="ForgetPwd" value="Iniciar sesión">Ya tiene un usuario? Inicie sesión aquí</a>
                    </div>
                </form>
            </div>
        </div>
